...
public abstract class AbstractTreeModel implements TreeModel {
	...
	public void fireTreeStructureChanged() {
		...
		for (int i = listeners.length - 2; i >= 0; i -= 2) {
			if (listeners[i] == TreeModelListener.class) {
				// Lazily create the event:
				if (e == null) e = new TreeModelEvent(this, new TreePath(getRoot()));
	...
	public void fireLastPathComponentChanged(TreePath path) {
		fireTreeNodesChanged(this, path.getPath(), new int[] {}, new Object[] {});
	}
	...
	public void fireLastPathComponentInserted(TreePath treePath) {
		...
		fireTreeNodesInserted(this, treePath.getParentPath().getPath(), new int[] { index }, new Object[] { leaf });
	}
	...
	public void fireLastPathComponentRemoved(TreePath treePath) {
		...
		fireTreeNodesRemoved(this, treePath.getParentPath().getPath(), new int[] { index }, new Object[] { leaf });
	}
